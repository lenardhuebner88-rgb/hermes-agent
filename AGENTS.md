...
## Fork-Ergänzungen (Hermes-Fork, nicht Upstream)

Dieser Fork hat eigene Regeln, die hier bewusst NICHT eingemischt werden, damit diese
Datei beim Upstream-Sync konfliktfrei bleibt: **`docs/fork/AGENTS-fork.md`**.
