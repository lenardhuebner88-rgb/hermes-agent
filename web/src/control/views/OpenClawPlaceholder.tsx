...
export function OpenClawPlaceholder() {
  return (
    <section className="hc-card space-y-4 p-5">
      ...
      <div><p className="hc-eyebrow">B3 zur?ckgestellt</p><h2 className="mt-1 text-xl font-semibold text-white">OpenClaw kommt bald</h2><p className="mt-2 max-w-2xl hc-soft">Der Tab bleibt sichtbar, aber ohne Read-only-Proxy bauen wir hier keine Scheinsteuerung.</p></div>
