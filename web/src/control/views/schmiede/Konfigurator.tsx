  ...
  return (
    <div className="grid min-w-0 grid-cols-1 gap-4">
      ...
      <FleetPanel eyebrow="Live-Vorschau" meta={<CopyButton text={preview} label="Kopieren" copiedLabel="Kopiert" />}>
        <pre className="hc-mono max-h-[420px] overflow-auto whitespace-pre-wrap break-words rounded-md bg-black/30 p-3 text-xs leading-relaxed text-white/90">{preview}</pre>
      </FleetPanel>
