  ...
  return (
    <div className="space-y-4">
          ...
          <section className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            <DetailMetric label={de.backlog.statusLabel} value={item.status || "-"} tone={metricTone(STATUS_TONE[item.status])} />
          ...
          <section className="border-t border-line-soft pt-3">
            ...
            <dl className="mt-2 space-y-2 text-body">
              <div><dt className="font-display text-micro uppercase tracking-[0.08em] text-ink-3">{de.backlog.pathLabel}</dt><dd className="break-words font-data text-ink">{detail?.source_path || sourceRef(item)}</dd></div>
              <div><dt className="font-display text-micro uppercase tracking-[0.08em] text-ink-3">{de.backlog.refLabel}</dt><dd className="break-words font-data text-ink">{detail?.source_ref || "git:origin/main"}</dd></div>
            </dl>
          </section>
