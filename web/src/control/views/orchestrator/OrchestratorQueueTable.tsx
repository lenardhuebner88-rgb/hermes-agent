...
export function OrchestratorQueueTable({
  ...
  return (
    <section className="overflow-hidden rounded-panel border border-line bg-surface-1">
      ...
      <div className="hidden grid-cols-[minmax(220px,2fr)_96px_112px_112px_84px_140px_150px_minmax(160px,1.2fr)] gap-3 border-b border-line-soft bg-surface-2 px-3 py-2 font-display text-micro font-semibold uppercase tracking-[0.08em] text-ink-3 md:grid">
        ...
        {items.map((item) => {
          ...
          return (
            <div
              ...
              className={cn(
                "grid min-h-12 w-full cursor-pointer grid-cols-1 gap-2 px-3 py-3 text-left transition hover:bg-surface-3 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-live/60 md:grid-cols-[minmax(220px,2fr)_96px_112px_112px_84px_140px_150px_minmax(160px,1.2fr)] md:items-center md:gap-3",
                isNext && "bg-live/5",
              )}
            >
