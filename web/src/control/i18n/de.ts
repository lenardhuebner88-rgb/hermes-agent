export const de = {
  ...
  fleet: {
    ...
    reviewEyebrow: "Review-Verdicts",
    reviewMeta: (n: number) => `${n} ${n === 1 ? "Task" : "Tasks"} im Review`,
    ...
    receiptTestLog: "receipt + test log",
    receiptOnly: "receipt",
    details: "Details",
  ...
  worker: {
    ...
    runawayWarn: "Runaway-Verdacht",
    runawayCritical: "Runaway",
    actionFailed: "Aktion fehlgeschlagen",
  },
  autoresearch: {
