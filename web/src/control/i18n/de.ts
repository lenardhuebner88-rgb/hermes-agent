export const de = {
  ...
  backlog: {
    ...
    sortAge: "Alter",
    sortStatus: "Status",
    // Queue-Tabellenköpfe (FoBacklogQueueTable)
    colTitle: "Titel",
    colStatus: "Status",
    colRisk: "Risiko",
    colOwner: "Verantwortlich",
    colArea: "Bereich",
    colAgeUpdated: "Alter/Aktualisiert",
    colStaleProof: "Überfällig/Nachweis",
    colSourceId: "Quelle/Id",
    colNextAction: "Nächster Schritt",
