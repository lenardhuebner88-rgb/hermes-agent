export const de = {
  ...
  fleet: {
    ...
    // Worker-Tab V2 (Mockup 2026-07-27): Dedupe, Liveness, ehrliche Tokens,
    // Drawer-Anreicherung, Outcome, Timeline, Queue-Vorschau.
    tickerLoading: "Lädt Ereignisse …",
    notesLoading: "Lädt Notizen …",
    foreignBoardHint: "Fremd-Board · Worker nur beobachten. Keine Board-übergreifende Steuerung.",
    chainStateRunning: "läuft",
    chainStateDone: "fertig",
    chainStateWaiting: "wartet",
    drawerRunningSince: (elapsed: string, assignee: string) => `läuft seit ${elapsed} · ${assignee}`,
    pulseQueueBoardSuffix: "(Board)",
    pulseScopeAllBoards: "alle Boards",
    pulseScopeBoard: "Board",
    pulseActive: "aktiv",
    pulseCapLabel: "Cap",
    pulseAllBoardsSuffix: "(alle Boards)",
    pulseTokensCloseout: "Werte beim Closeout",
    pulseTokensToday: (sum: string) => `heute ${sum}`,
    livenessRunning: "läuft",
    livenessSuspect: "verdächtig",
    livenessFailed: "ausgefallen",
    livenessObserved: (at: string) => `beobachtet ${at}`,
    livenessUnknown: "kein Signal",
    drawerLiveness: "Liveness",
    drawerClaim: "Claim",
    drawerClaimExpires: "Claim läuft ab",
    claimExpired: "abgelaufen",
    claimExpiresIn: (in_: string) => `in ${in_}`,
    drawerWorktree: "Worktree",
    drawerBranch: "Branch",
    drawerAutoRetries: "Auto-Retries",
    drawerReviewTier: "Review-Tier",
    copyValue: "kopieren",
    copiedValue: "kopiert",
    copyAriaLabel: (what: string) => `${what} kopieren`,
    outcomeTitle: "Run-Ausgang",
    outcomeState: "Ausgang",
    outcomeEndedAt: (at: string) => `beendet ${at}`,
    outcomeVerdict: "Verdict",
    outcomeError: "Fehler",
    outcomeSummary: "Summary",
    outcomeLoading: "Lädt Ausgang …",
    timelineTitle: "Run-Timeline",
    timelineEmpty: "Noch keine Timeline-Ereignisse.",
    timelineLoading: "Lädt Timeline …",
    timelineTruncated: (n: number) => `älteste Ereignisse gekappt (${n} gezeigt)`,
    timelineNow: "jetzt",
    queueNextLabel: "Nächste in Queue",
    queueScheduledLabel: "wartet auf Freigabe/Termin",
    drawerInspect: "CPU / RSS",
    inspectUnavailable: "kein Live-Inspect",
    // Fenster-Herkunft für Ring/Skala (F3): „p90" nur bei echtem eta_p90.
    windowP90Label: "p90",
    windowCapLabel: "Cap",
    windowApproxLabel: "≈",
    // i18n-Nachzug (F11)
    tickerRepeated: (n: number) => `${n}× wiederholt`,
    livenessOrbLabel: (state: string) => `Liveness: ${state}`,
    workerOpenAria: (profile: string) => `Worker ${profile} öffnen`,
    claimChipPrefix: "claim",
    liveEventsSource: "Live-Ereignisse",
    drawerAriaLabel: (profile: string) => `Worker ${profile} Details`,
    drawerRunSuffix: (runId: string) => ` · Run ${runId}`,
    reliabilityCompleted: (pct: number) => `${pct} % abgeschlossen`,
    reliabilityRetries: (n: number) => ` · ${n} Retries`,
    copyUnavailable: "Kopieren nur über HTTPS",
    notesMore: (n: number) => `+${n} weitere`,
    outcomeNotFound: "Kein Ausgang lesbar — der Run ist nicht (mehr) in der API.",
    // F10: Fenster-Position für die Karten-aria-Zusammenfassung.
    windowNone: "kein Zeitfenster",
    windowOver: (label: string) => `${label} überschritten`,
    windowWithin: (pct: number, label: string) => `${pct} % von ${label}`,
    // 24h-Outcome-Übersicht (Sektion „Letzte 24 Stunden")
    outcomesTitle: "Letzte 24 Stunden",
    outcomesRunsCount: (n: number) => `${n} ${n === 1 ? "Run" : "Runs"}`,
    outcomesDistribution: "Outcome-Verteilung",
    outcomesRuns: "Runs",
    outcomesEmpty: "Keine Runs im Fenster.",
    outcomesLoading: "Lädt Ausgänge …",
    outcomesError: "Quelle meldet Fehler — Ausgänge derzeit nicht lesbar.",
    eventKindLabels: {
      heartbeat: "Heartbeat",
      claimed: "geclaimt",
      blocked: "blockiert",
      ...
      crashed: "Crash",
      gave_up: "aufgegeben",
      auto_retried: "Auto-Retry",
      unblocked: "entsperrt",
      submitted_for_review: "zur Review",
      review_released: "Review frei",
      integration_merged: "gemergt",
      run_started: "Run gestartet",
      run_ended: "Run beendet",
    ...
    laufkartenTitle: "Laufkarten",
    laufEyebrowLaeuft: (cur: number, total: number) => `Läuft · Station ${cur} von ${total}`,
    ...
    laufAgeWartet: (age: string) => `wartet seit ${age}`,
    laufAgeGeradeEben: "gerade eben",
    laufStationLaeuft: (runtime: string) => `läuft · ${runtime}`,
    laufStationBereit: "bereit",
    laufStationWartet: "wartet auf Freigabe",
    laufWeitere: (hidden: number, total: number) => `… +${hidden} weitere von ${total} Stationen`,
  ...
  loops: {
    ...
    effortLabel: (phase: string) => `Reasoning-Effort für ${phase}`,
    effortDefault: "STD",
    effortDefaultTitle: "Standard — kein Flag, es gilt der CLI-Default der Engine",
    effortUnsupported: "Diese Engine transportiert keinen Reasoning-Effort.",
    autolandToggleLabel: "Nach grünem Verify automatisch landen",
    autolandConfirmLabel: (pack: string) => `Zum Bestätigen den Pack-Namen eingeben: ${pack}`,
    autolandConfirmMismatch: "Name stimmt nicht — Autoland bleibt aus.",
    autolandOperatorHint:
      "Gates bleiben bindend: Verify-PASS, Visual-Gate, Land-Gates, genau ein Commit, sauberer Worktree, ff-only. Auth, kanban_db, Lockfiles, CI und der Runner selbst landen nie.",
    ...
    typeDeterministic: "Deterministisch",
    landingSectionLabel: "Landing-Automatik",
    landingAutomation: "Automatik",
    landingAutomationOn: "an",
    landingAutomationOff: "aus",
    landingAutomationHint:
      "Bei ausgeschalteter Automatik laufen keine Event-Läufe, keine Reconciliation und keine Recovery-Anfragen — Vorschau und manuelle Ausführung bleiben erlaubt.",
    landingAutomationFailed: "Automatik konnte nicht umgeschaltet werden",
    landingQueueLabel: "Queue",
    landingQueue: (total: number, landed: number, cleaned: number, parked: number) =>
      `${total} · gelandet ${landed} · bereinigt ${cleaned} · geparkt ${parked}`,
    landingQueueEmpty: "Queue leer",
    landingBaselineLabel: "Baseline",
    landingBaselineOk: "grün",
    landingBaselineFail: "nicht grün",
    landingBaselineUnknown: "unbekannt",
    landingBaselineEvidenceLabel: "Nachweis",
    landingBaselineSourceNightly: "Nightly",
    landingBaselineSourceLanding: "Landing",
    landingBaselineSourceNone: "fehlt",
    landingNextTriggerLabel: "Nächster Trigger",
    landingNoTrigger: "keiner geplant",
    landingWindowOpen: (closes: string) => `Sammelfenster bis ${closes}`,
    landingLastResultLabel: "Letztes Ergebnis",
    landingResultGreen: "grün",
    landingResultHeld: "zurückgehalten",
    landingResultUnknown: "—",
    landingPreview: "Vorschau",
    landingPreviewHint: "Dry-Run — ändert keine Refs und startet keinen echten Lauf",
    landingPreviewFailed: "Vorschau konnte nicht gestartet werden",
    landingCandidates: "Kandidaten",
    landingNoCandidates: "Keine Kandidaten in der Queue.",
    landingCandidateDelta: (ahead: number, behind: number) => `+${ahead}/−${behind}`,
    landingOriginTask: "Ursprungskarte",
    landingGateStages: "Gate-Stufen",
    landingNoGateStages: "Gate-Stufen unbekannt.",
    landingRecovery: "Recovery",
    landingNoRecovery: "Keine Recovery-Anfragen.",
    landingRecoveryRequested: "angefordert",
    landingRecoveryStarted: "gestartet",
    landingRecoveryExhausted: "erschöpft",
    landingRecoveryAttempt0: "Versuch 0",
    landingRecoveryAttempt1: "Versuch 1",
    landingTriggerHistory: "Trigger-Historie",
    landingNoTriggers: "Keine Trigger-Signale.",
    landingFollowupPending: "Folgelauf vorgemerkt",
    landingPreviewTitle: "Vorschau (Dry-Run)",
    landingPreviewRunning: "Vorschau läuft …",
    landingPreviewFinished: (rc: number) => `Vorschau beendet · Exit ${rc}`,
    landingPreviewStale: "Vorschau ohne Ergebnis abgebrochen",
    landingPreviewNone: "Noch keine Vorschau gestartet.",
    loading: "lädt …",
  ...
  backlog: {
    ...
    area: "Bereich",
    lane: "Lane",
    // FoDetailDrawer: Abschnitte und Aktionen
    nextAction: "Nächster Schritt",
    decisionWhyNow: "Entscheidung / Warum jetzt",
    acceptanceCriteria: "Akzeptanzkriterien",
    evidenceProof: "Aktuelle Belege / Letzter Beleg",
    blockers: "Blocker",
    sourcePathRef: "Quell-Pfad/Ref",
    pathLabel: "Pfad",
    refLabel: "Ref",
    copyBrief: "Operator-Brief kopieren",
    copyPrompt: "Implementierungs-Prompt kopieren",
    result: "Ergebnis",
