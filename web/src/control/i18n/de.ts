export const de = {
  ...
  loops: {
    ...
    empty: "Keine Loop-Packs gefunden.",
    ...
    commitsAhead: (n: number) => `${n} unverdaute ${n === 1 ? "Commit" : "Commits"}`,
    commitsAheadHint: "Wartet auf Morgen-Review, bevor gemergt wird.",
    queuePlanned: "geplant",
    queueBuilding: "in Arbeit",
    queueVerified: "verifiziert",
    queueLanded: "gelandet",
    queueBounced: "zurückgewiesen",
    timerLabel: "Nacht-Timer",
    timerOn: "aktiv",
    timerOff: "aus",
    actions: { start: "Start", stop: "Stop", detail: "Details", land: "Landen", workshop: "Werkstatt" },
    ...
    detailLedger: "Ledger (letzte Zeilen)",
    detailQueue: "Queue-Einträge",
    ...
    confirmLand: "Landen? Schienen: ff-only, Gates, Rollback-Anker — Ergebnis erscheint im Ledger.",
