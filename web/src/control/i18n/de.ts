export const de = {
  ...
  flow: {
    ...
    capture: {
      ...
      modeLabel: "Wie soll die Aufgabe starten?",
      modePark: "Parken (selbst dispatchen)",
      modeParkHint: "Landet geparkt in „Plan“. Es startet kein Worker von selbst — du klickst danach „Dispatch“.",
      modeOrchestrate: "An Orchestrator (Triage) · Standard",
      modeOrchestrateHint: "Landet in „Capture“. Der Orchestrator zerlegt deinen rohen Prompt in Subtasks bzw. routet ihn zum passenden Worker (~60 s).",
      submit: "Erfassen",
      submitting: "Erfasse …",
      donePark: "Geparkt",
      doneOrchestrate: "An Orchestrator",
      cancel: "Abbrechen",
    },
  },
  pulse: {
