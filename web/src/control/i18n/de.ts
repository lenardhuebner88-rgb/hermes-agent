export const de = {
  ...
  flow: {
    ...
    capture: {
      ...
      modePark: "Parken (sicher)",
      modeParkHint: "Landet geparkt in „Plan“. Es startet kein Worker von selbst — du klickst danach „Dispatch“.",
      modeOrchestrate: "An Orchestrator",
      modeOrchestrateHint: "Landet in „Capture“. Der Orchestrator triagiert automatisch und kann einen Worker starten.",
      submit: "Erfassen",
      submitting: "Erfasse …",
      donePark: "Geparkt",
