...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useEffect(() => {
    ...
    // Scroll browser-side transcript history instead of forwarding wheel
    // protocol bytes into the PTY as if they were typed input.
    ...
    // WebGL can produce oversized cells on narrow/mobile hosts. Use the
    // default renderer there and retain WebGL on wide layouts.
