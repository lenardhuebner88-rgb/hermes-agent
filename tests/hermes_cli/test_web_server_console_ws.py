...
def test_console_uses_dedicated_bounded_executor():
    executor = web_server._get_console_executor()
    assert executor._max_workers == web_server._CONSOLE_EXECUTOR_MAX_WORKERS
    assert executor._thread_name_prefix == "hermes-console"
