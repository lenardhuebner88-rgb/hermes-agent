...
def test_parked_branch_keeps_its_verified_plans(git_world):
    """Control: the archiving must be bound to an actual landing.

    Without this the same code would look 'green' while silently retiring plans
    for work that never reached main.
    """
