...
def test_approve_draft_creates_linked_ready_child_with_inferred_contract(conn):
    ...
    assert "code_task_contract_inferred" in kinds
    assert "needs_contract_blocked" not in kinds
    link = conn.execute(
