"""Fork-eigene Tests des Kanban-Notifiers.

Ausgelagert beim Upstream-Vollmerge 2026-08-04: tests/gateway/test_kanban_notifier.py
gehoert Upstream und bleibt dort unveraendert, damit kuenftige Syncs dort nicht mehr
kollidieren (Canon-Regel: Fork-Code in ein fork-eigenes Modul). Hier stehen nur die
Tests, die es bei Upstream NICHT gibt; geteilte Tests bleiben in Upstreams Datei und
gelten in Upstreams Fassung.
"""
import asyncio
