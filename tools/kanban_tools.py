        ...
        try:
            ...
            if task and task.goal_mode and _goal_judge_available():
                ...
                try:
                    ...
                    # wait_directive) after this gate's Upstream origin; accept
                    # both so a future arity change doesn't silently break the
                    # gate — see hermes_cli/goals.py:run_kanban_goal_loop for
                    # the same compat shim.
