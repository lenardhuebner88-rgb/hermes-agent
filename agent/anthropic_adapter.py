...
def _convert_user_message(m: Any) -> Dict[str, Any]:
    ...
    """
    # Internal callers pass the full message envelope so the cache marker can
    # be forwarded. Preserve the historical helper contract too: direct
    # callers may pass a string/list content value.
