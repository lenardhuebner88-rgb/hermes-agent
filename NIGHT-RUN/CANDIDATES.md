...
- [x] `hermes_cli/cron_observability.py` (168 LoC) — `tests/hermes_cli/test_cron_observability.py`
- [x] `hermes_cli/kanban_dispatch_policy.py` (168 LoC) — `tests/hermes_cli/test_kanban_dispatch_policy.py`
...
- [x] `hermes_cli/metrics_lite.py` (119 LoC) — `tests/hermes_cli/test_metrics_lite.py`
- [x] `hermes_cli/claude_cli_model_catalog.py` (116 LoC) — `tests/hermes_cli/test_claude_cli_model_catalog.py`
...
- [x] `hermes_cli/pa_reminders.py` (87 LoC) — `tests/hermes_cli/test_pa_reminders.py`
- [x] `hermes_cli/kanban_escalation_class.py` (86 LoC) — `tests/hermes_cli/test_kanban_escalation_class.py`
- [x] `hermes_cli/oneshot_service_tier.py` (80 LoC) — `tests/hermes_cli/test_oneshot_service_tier.py` (REJECTED: equivalent survivor)
- [x] `hermes_cli/voice_health_track.py` (76 LoC) — `tests/hermes_cli/test_voice_health_track.py`
