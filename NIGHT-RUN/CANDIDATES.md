...
- [ ] `hermes_cli/kanban_lane_fixer.py` (606 LoC) — `tests/hermes_cli/test_kanban_lane_fixer.py`
- [ ] `hermes_cli/host_usage.py` (590 LoC) — `tests/hermes_cli/test_host_usage.py`
- [ ] `hermes_cli/kanban_discord_report.py` (583 LoC) — `tests/hermes_cli/test_kanban_discord_report.py`
- [ ] `hermes_cli/control_plane_gate.py` (570 LoC) — `tests/hermes_cli/test_control_plane_gate.py`
- [ ] `hermes_cli/pressure_status.py` (570 LoC) — `tests/hermes_cli/test_pressure_status.py`
- [ ] `hermes_cli/pa_journal.py` (514 LoC) — `tests/hermes_cli/test_pa_journal.py`
- [ ] `hermes_cli/library_corrections.py` (505 LoC) — `tests/hermes_cli/test_library_corrections.py`
- [ ] `hermes_cli/pa_actions.py` (479 LoC) — `tests/hermes_cli/test_pa_actions.py`
- [ ] `hermes_cli/funnel.py` (469 LoC) — `tests/hermes_cli/test_funnel.py`
- [ ] `hermes_cli/pa_loops.py` (464 LoC) — `tests/hermes_cli/test_pa_loops.py`
- [ ] `hermes_cli/disposition.py` (458 LoC) — `tests/hermes_cli/test_disposition.py`
- [ ] `hermes_cli/auto_release.py` (442 LoC) — `tests/hermes_cli/test_auto_release.py`
- [ ] `hermes_cli/symbol_test_narrowing.py` (439 LoC) — `tests/hermes_cli/test_symbol_test_narrowing.py`
- [ ] `hermes_cli/capability_researcher.py` (438 LoC) — `tests/test_capability_researcher.py`
- [ ] `hermes_cli/memory_digest.py` (438 LoC) — `tests/hermes_cli/test_memory_digest.py`
- [ ] `hermes_cli/library_models.py` (425 LoC) — `tests/hermes_cli/test_library_models.py`
- [ ] `hermes_cli/terminal_candidates.py` (416 LoC) — `tests/hermes_cli/test_terminal_candidates.py`
- [ ] `hermes_cli/agent_question_push.py` (389 LoC) — `tests/hermes_cli/test_agent_question_push.py`
- [ ] `hermes_cli/gate_leaker.py` (389 LoC) — `tests/hermes_cli/test_gate_leaker.py`
- [ ] `hermes_cli/goal_judge_rendering.py` (379 LoC) — `tests/hermes_cli/test_goal_judge_rendering.py`
- [ ] `hermes_cli/kanban_close_sprint.py` (374 LoC) — `tests/hermes_cli/test_kanban_close_sprint.py`
- [ ] `hermes_cli/strategist_surface.py` (366 LoC) — `tests/hermes_cli/test_strategist_surface.py`
- [ ] `hermes_cli/library_results.py` (356 LoC) — `tests/hermes_cli/test_library_results.py`
- [ ] `hermes_cli/pa_health.py` (350 LoC) — `tests/hermes_cli/test_pa_health.py`
- [ ] `hermes_cli/pa_news.py` (342 LoC) — `tests/hermes_cli/test_pa_news.py`
- [ ] `hermes_cli/design_board_kanban.py` (327 LoC) — `tests/test_design_board_kanban.py`
- [ ] `hermes_cli/library_state.py` (323 LoC) — `tests/hermes_cli/test_library_state.py`
- [ ] `hermes_cli/autoresearch_lane_contracts.py` (322 LoC) — `tests/hermes_cli/test_autoresearch_lane_contracts.py`
- [ ] `hermes_cli/health_status.py` (322 LoC) — `tests/hermes_cli/test_health_status.py`
- [ ] `hermes_cli/kanban_shadow_routing.py` (286 LoC) — `tests/hermes_cli/test_kanban_shadow_routing.py`
- [ ] `hermes_cli/agent_question_suggest.py` (285 LoC) — `tests/hermes_cli/test_agent_question_suggest.py`
- [ ] `hermes_cli/scoped_auto_commit.py` (281 LoC) — `tests/hermes_cli/test_scoped_auto_commit.py`
...
- [ ] `hermes_cli/system_stats_history.py` (224 LoC) — `tests/hermes_cli/test_system_stats_history.py`
- [ ] `hermes_cli/plan_prose.py` (221 LoC) — `tests/hermes_cli/test_plan_prose.py`
- [ ] `hermes_cli/autoresearch_lane_models.py` (209 LoC) — `tests/test_autoresearch_lane_models.py`
- [ ] `hermes_cli/kanban_score_hygiene.py` (184 LoC) — `tests/hermes_cli/test_kanban_score_hygiene.py`
- [ ] `hermes_cli/stats_config.py` (180 LoC) — `tests/test_stats_config.py`
- [ ] `hermes_cli/pa_titles.py` (178 LoC) — `tests/hermes_cli/test_pa_titles.py`
- [ ] `hermes_cli/design_board_store.py` (171 LoC) — `tests/test_design_board_store.py`
