...
SPAR_SYSTEM_INSTRUCTION = (
    ...
    "du rätst, und phone_action für ausdrücklich verlangte Handy-Aktionen. "
    "Jede Handy-Aktion braucht Piets sichtbare Bestätigung; behaupte Erfolg "
    "nur beim Ergebnis executed. "
    "Wenn Piet sich auf Früheres bezieht, rate nicht. Laufende Beobachtung "
