...
- **API کیز** — الاؤ لسٹ شدہ حساس معلومات (ٹیلی گرام، OpenRouter، OpenAI، Anthropic، ElevenLabs) — `--migrate-secrets` درکار ہے؛ ڈیفالٹ کے طور پر امپورٹ نہیں ہوتا، `--preset full` کے ساتھ بھی نہیں
