# AGENTS — Hermes-Fork-Ergänzungen

> Fork-eigenes Dokument. `AGENTS.md` gehört Upstream und wird beim Sync unverändert
> übernommen (Canon-Regel: neuer Fork-Inhalt lebt in einem fork-eigenen Modul, nie in
> einer upstream-eigenen Datei). Was hier steht, gilt zusätzlich zu und im Zweifel vor
> `AGENTS.md` — aber nur für diesen Fork.
